    ...
    reader.onload = (event) => {
      ...
      lines.forEach((line, idx) => {
        ...
        if (parts.length >= 6 && idx > 0) {
           ...
           else if (correctKey === 'c' || correctKey.includes('option b')) correctKey = 'optionB';
                     ...
                     <tr>
                      ...
                      testResults.map((res) => (
                       <tr key={res.id} className="hover:bg-gray-50">
                         ...
                         {/* UPDATED PASS MARK VISUAL TO 40% */}
      ...
      <div className="min-h-screen bg-gray-50 p-4 font-sans text-gray-900 overflow-y-auto">
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-xl text-center">
            ...
            {/* --- MOVED: APP NAME AND TITLE TO TOP --- */}
            <div className="mb-2">
                <h3 className="text-sm md:text-base font-bold text-gray-500 uppercase tracking-wider">{appName}</h3>
                <h1 className="text-xl md:text-2xl font-bold text-blue-900 uppercase">{testTitle}</h1>
            </div>

            {/* --- MOVED: ICON TO HERE (Middle) --- */}
            ...
            <h2 className="text-lg md:text-xl font-medium text-gray-600 mb-6">Test Completed</h2>
